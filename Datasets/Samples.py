...
def get_samples( basedir, period ):
    ...
    samples = {
        'Signal_TTto2L2Nu_MTT-0to700':      [i for i in list_basedir if 'Signal_TTto2L2Nu_MTT-0to700' == i.split("_"+periodTag)[0]],
        'Signal_TTto2L2Nu_MTT-700to900':    [i for i in list_basedir if 'Signal_TTto2L2Nu_MTT-700to900' == i.split("_"+periodTag)[0]],
        'Signal_TTto2L2Nu_MTT-900toInf':    [i for i in list_basedir if 'Signal_TTto2L2Nu_MTT-900toInf' == i.split("_"+periodTag)[0]],
